...
const Cart = () => {
  ...
  // var totalPrice = cartItems.reduse((total,item) => total + item.qty * item.price,0);
  ...
  return  (
   <>
    ...
    className={`text-5xl bg-white shadow-md p-3 fixed bottom-4 right-4
     hover:bg-yellow-500 rounded-full bg-contain ${totalQty > 0 && "animate-bounce delay-500 transition-all"}`}/> 
